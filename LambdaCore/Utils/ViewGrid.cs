...
namespace LambdaManager.Utils
{
    ...
    {
        public View? GetIdleOrNewView(int index);
    ...
    public class ViewGrid: IViewGrid
    {
        ...
        private readonly List<int> ClosingViewIndex = Common.ClosingViewIndex;

        private View?[] Views { get; set; } = Common.Views;

        public Grid[] gridsList = new Grid[100];
        ...
        private Grid GetNewGrid(Image image)
        {
            Grid grid = new Grid()
            {
        ...
        public View AddView(Image image)
        {
        ...
        private View AddView(int index)
        {
