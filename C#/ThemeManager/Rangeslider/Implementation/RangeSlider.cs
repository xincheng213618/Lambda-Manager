...
namespace ThemeManager.Rangeslider
{
    ...
    public class RangeSlider : Control
    {
        ...
        static RangeSlider()
        {
            ...
            DefaultStyleKeyProperty.OverrideMetadata(typeof(RangeSlider), new FrameworkPropertyMetadata(GetDefautlStyle()));
        }
        ...
        public static readonly DependencyProperty SlidThumbVisProperty = DependencyProperty.Register("SlidThumbVis", typeof(Visibility), typeof(RangeSlider)
                , new FrameworkPropertyMetadata(Visibility.Visible));

        public Visibility SlidThumbVis
        {
            get
            {
                return (Visibility)GetValue(RangeSlider.SlidThumbVisProperty);
            }
            set
            {
                SetValue(RangeSlider.SlidThumbVisProperty, value);
            }
        }
